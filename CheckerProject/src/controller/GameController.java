...
public class GameController {
     ...
     *   5. UC1.19: Khôi phục noCaptureMoveCount từ GameState
     *
    ...
    public boolean loadGame() {
        ...
        // UC1.19: khôi phục bộ đếm không capture
        this.noCaptureMoveCount = (state.noCaptureMoveCount >= 0) ? state.noCaptureMoveCount : 0;
    ...
    private void findCaptureMoves(Board b, int curR, int curC,
        ...
        for (int[] d : ALL_DIRS) {
           ...
           // UC1.12 - Nhảy qua quân đối phương
            ...
            // Kiểm tra quân trước mặt, và ô đặt sau quân bị ăn không có quân nào
